...
int main_exit;
void menu();
//we use structures, it is a user defined data type used to group elements of diffrent data types into a single type
struct date{
    int month,day,year;
    };
struct{
...
void close(void)
{
    printf("\n\n\n\nThis C Mini Project is developed by shikha and team!");
    }
...
int main()
{
    char pass[10],password[10]="SHIKHA";
    int i=0;
